...
describe('Pruebas en HeroScreen', () => {
    ...
    test('debe de regresar a la pantalla anterior', () => {
        ...
        wrapper.find('button').prop('onClick')(); //buscamos el boton y le damos click (es un return)
    ...
    test('debe de mostrar el No Hero Page si no tenemos un héroe', () => {
        ...
        const wrapper = mount(//héroe que no existe
            <MemoryRouter initialEntries={ ['/hero/marvel-spider3232323']}> 
                <Routes>
                    <Route path="/hero/:heroeId" element={ <HeroScreen />} />
                    <Route path="/" element={ <h1>No Hero Page</h1>} />
                </Routes>
